...
public class ActionFireRelayOneTick extends ScriptAction {

	private BlockScripter bs;
	
	public ActionFireRelayOneTick(String name, BlockScripter bs) {
		super("fireRelay", name, new TargetType[] { TargetType.BLOCK});
		this.bs = bs;
	}
